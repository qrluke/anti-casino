...
if enable_sentry then
  ...
  if sentry_loaded and Sentry then
    pcall(Sentry().init, { dsn = "https://4f2a50d668ae4d458803d78b55cd5401@o1272228.ingest.sentry.io/6529768" })
  end
end
...
if enable_autoupdate then
  ...
  if updater_loaded then
    ...
    if autoupdate_loaded then
      Update.json_url = "https://raw.githubusercontent.com/qrlk/anti-casino/master/version.json?" .. tostring(os.clock())
      Update.prefix = "[" .. string.upper(thisScript().name) .. "]: "
      Update.url = "https://github.com/qrlk/anti-casino"
    end
  end
end
